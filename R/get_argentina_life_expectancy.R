...
#' Get Argentina's Life Expectancy at Birth (Total, Years) from World Bank
#'
#' @description
...
#'
#' @export
get_argentina_life_expectancy <- function() {
  url <- "https://api.worldbank.org/v2/country/ARG/indicator/SP.DYN.LE00.IN?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)

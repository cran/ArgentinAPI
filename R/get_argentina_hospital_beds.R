...
#' Get Argentina's Hospital Beds (per 1,000 people) from World Bank
#'
#' @description
...
#'
#' @export
get_argentina_hospital_beds <- function() {
  url <- "https://api.worldbank.org/v2/country/ARG/indicator/SH.MED.BEDS.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)

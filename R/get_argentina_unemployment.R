...
#' Get Argentina's Unemployment Rate (Total) from World Bank
#'
#' @description
...
#'
#' @export
get_argentina_unemployment <- function() {
  url <- "https://api.worldbank.org/v2/country/ARG/indicator/SL.UEM.TOTL.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)

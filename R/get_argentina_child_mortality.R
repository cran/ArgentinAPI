...
#' Get Argentina's Under-5 Mortality Rate from World Bank
#'
#' @description
...
#'
#' @export
get_argentina_child_mortality <- function() {
  url <- "https://api.worldbank.org/v2/country/ARG/indicator/SH.DYN.MORT?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)

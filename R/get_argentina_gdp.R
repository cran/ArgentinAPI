...
#' Get Argentina's GDP (current US$) from World Bank
#'
#' @description
...
#'
#' @export
get_argentina_gdp <- function() {
  url <- "https://api.worldbank.org/v2/country/ARG/indicator/NY.GDP.MKTP.CD?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)

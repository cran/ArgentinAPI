...
test_that("get_argentina_child_mortality() returns a tibble with correct structure", {
  skip_on_cran()
  result <- get_argentina_child_mortality()
...
test_that("get_argentina_child_mortality() returns correct column types", {
  skip_on_cran()
  result <- get_argentina_child_mortality()
...
test_that("get_argentina_child_mortality() returns expected values for Argentina", {
  skip_on_cran()
  result <- get_argentina_child_mortality()
